-- Insertion des questionnaires avec encodage UTF-8 correct
SET client_encoding = 'UTF8';

-- Supprimer toutes les données liées aux questionnaires dans l'ordre correct
-- (à cause des contraintes de clés étrangères)
DELETE FROM matches;          -- Supprimer les matches (basés sur les réponses)
DELETE FROM user_responses;   -- Supprimer les réponses utilisateurs
DELETE FROM questionnaires;   -- Supprimer les questionnaires
